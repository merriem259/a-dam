...
def login_to_gee():
    try:
        ...
        credentials = service_account.Credentials.from_service_account_file(SERVICE_ACCOUNT_FILE, scopes=['https://www.googleapis.com/auth/earthengine.readonly'])
    ...
    if not df.empty:
        ...
        with tab1:
            ...
            with c2:
                ...
                # ── [NEW] IMAGE ACQUISITION DATE/TIME ──────────────────────
        ...
        with tab2:
            ...
            if len(df_ml) > 10:
                ...
                last_lags_ndti = last_row  # 9 values: 3 lags × 3 features
                for _ in range(7):
                ...
                # ── NDWI FORECAST TABLE ─────────────────────────────────────
                # NDWI risk logic: values below 0 indicate little/no water (High risk);
                # values above 0 indicate presence of water (Low risk / normal).
